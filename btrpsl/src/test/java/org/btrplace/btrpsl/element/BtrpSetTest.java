...
public class BtrpSetTest {
    ...
    public void testToString() {
        ...
        s.getValues().add(new BtrpNumber(5, BtrpNumber.Base.BASE_10));
        s.getValues().add(new BtrpNumber(7, BtrpNumber.Base.BASE_10));
        s.getValues().add(new BtrpNumber(9, BtrpNumber.Base.BASE_10));
        s.getValues().add(new BtrpNumber(10, BtrpNumber.Base.BASE_10));
        Assert.assertNotNull(s.toString());
    }

    public void testViablePower() {
        BtrpSet s = new BtrpSet(1, BtrpOperand.Type.NUMBER);
        s.getValues().add(new BtrpNumber(2, BtrpNumber.Base.BASE_10));
        s.getValues().add(new BtrpNumber(3, BtrpNumber.Base.BASE_10));
        BtrpSet res = s.power(new BtrpNumber(2, BtrpNumber.Base.BASE_10));
    ...
    public void testNonViablePower2() {
        ...
        s.getValues().add(new BtrpNumber(2, BtrpNumber.Base.BASE_10));
        s.getValues().add(new BtrpNumber(3, BtrpNumber.Base.BASE_10));
        s.power(new BtrpNumber(-2, BtrpNumber.Base.BASE_10));
    }
    ...
    public void testViableAddition() {
        ...
        s2.getValues().add(new BtrpNumber(3, BtrpNumber.Base.BASE_10));
        res = s.plus(s2);
        Assert.assertEquals(res.getValues().size(), 3);
        Assert.assertTrue(res.getValues().containsAll(s.getValues()));
        Assert.assertTrue(res.getValues().containsAll(s2.getValues()));
    ...
    public void testViableDifference() {
        BtrpSet s = new BtrpSet(1, BtrpOperand.Type.NUMBER);
        s.getValues().add(new BtrpNumber(1, BtrpNumber.Base.BASE_10));
        s.getValues().add(new BtrpNumber(2, BtrpNumber.Base.BASE_10));
        s.getValues().add(new BtrpNumber(3, BtrpNumber.Base.BASE_10));

        BtrpSet s2 = new BtrpSet(1, BtrpOperand.Type.NUMBER);
        s2.getValues().add(new BtrpNumber(3, BtrpNumber.Base.BASE_10));
        s2.getValues().add(new BtrpNumber(5, BtrpNumber.Base.BASE_10));
    ...
    public void testViableTimes() {
        ...
        BtrpSet s2 = new BtrpSet(1, BtrpOperand.Type.NUMBER);
        s2.getValues().add(new BtrpNumber(1, BtrpNumber.Base.BASE_10));
        s2.getValues().add(new BtrpNumber(3, BtrpNumber.Base.BASE_10));
    ...
    public void testViableDiv() {
        BtrpSet s = new BtrpSet(1, BtrpOperand.Type.NUMBER);
        for (int i = 0; i < 11; i++) {
            s.getValues().add(new BtrpNumber(i, BtrpNumber.Base.BASE_10));
        }

        BtrpSet res = s.div(new BtrpNumber(3, BtrpNumber.Base.BASE_10));
        Assert.assertEquals(res.degree(), 2);
    ...
    public void testViableDiv2() {
        ...
        BtrpSet res = s.div(new BtrpNumber(4, BtrpNumber.Base.BASE_10));
        Assert.assertEquals(res.degree(), 2);
    ...
    public void testNonViableDivCauseZero() {
        ...
        s.div(new BtrpNumber(0, BtrpNumber.Base.BASE_10));
    }
    ...
    public void testNonViableDivCauseToBig() {
        ...
        s.div(new BtrpNumber(7, BtrpNumber.Base.BASE_10));
    }
    ...
    public void testViableRemainder() {
        ...
        BtrpSet res = s.remainder(new BtrpNumber(2, BtrpNumber.Base.BASE_10));
    ...
    public void testNonViableRemainderCauseZero() {
        BtrpSet s = new BtrpSet(1, BtrpOperand.Type.NUMBER);
        s.remainder(new BtrpNumber(0, BtrpNumber.Base.BASE_10));
    }
    ...
    public void testEq() {
        ...
        for (int i = 0; i < 6; i++) {
            s.getValues().add(new BtrpNumber(i, BtrpNumber.Base.BASE_10));
            s2.getValues().add(new BtrpNumber(i, BtrpNumber.Base.BASE_10));
        }
    ...
    public void testcopy() {
        ...
        BtrpSet s2 = s.copy();
        Assert.assertEquals(s, s2);
        s.getValues().add(new BtrpNumber(12, BtrpNumber.Base.BASE_10));
