...
perform)    
    ...
    git merge --no-ff -m "integrate the development version ${NEW_VERSION} generated by maven" ${RELEASE_BRANCH} || exit 1        
    ...
    git checkout master    
    git merge --no-ff ${RELEASE_BRANCH} -m "integrate the release "
