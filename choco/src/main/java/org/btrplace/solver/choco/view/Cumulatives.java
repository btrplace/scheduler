...
public interface Cumulatives extends ChocoView {
     ...
     * Add a new dimension.
     *
     * @param c    the capacity of each node. The variables *must be* ordered according to {@link org.btrplace.solver.choco.DefaultReconfigurationProblem#getNode(org.btrplace.model.Node)}.
