...
public abstract class Packing implements ChocoView {
     ...
     * @param l    the load of each VM. The variables *must be* ordered according to {@link org.btrplace.solver.choco.DefaultReconfigurationProblem#getVM(org.btrplace.model.VM)}.
     * @param s    the capacity of each node. The variables *must be* ordered according to {@link org.btrplace.solver.choco.DefaultReconfigurationProblem#getNode(org.btrplace.model.Node)}.
