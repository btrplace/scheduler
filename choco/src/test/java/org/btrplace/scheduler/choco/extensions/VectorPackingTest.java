...
public class VectorPackingTest {
    ...
    public void testIssue382() {
        ...
        final Model csp = new Model();
        final IntVar[] nodeLoad = new IntVar[4];
