...
public class KillVMTest {
    ...
    public void testBasics() throws ContradictionException, SolverException {
        ...
        dev.register(btrplace.plan.event.KillVM.class, new ConstantActionDuration(1));
        ...
        for (Action a : p) {
            if (a instanceof btrplace.plan.event.KillVM) {
                btrplace.plan.event.KillVM vma = (btrplace.plan.event.KillVM) a;
