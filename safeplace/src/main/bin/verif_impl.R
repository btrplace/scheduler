...
pdf(file=paste(args[2],"/continuous_repair.pdf",sep=""), width=5, height=5)
...
pdf(file=paste(args[2],"/continuous_rebuild.pdf",sep=""), width=5, height=5)
...
pdf(file=paste(args[2],"/discrete_repair.pdf",sep=""), width=5, height=5)
...
pdf(file=paste(args[2],"/discrete_rebuild.pdf",sep=""), width=5, height=5)
