...
/**
 * JSON Converter for the constraint {@link btrplace.model.constraint.JSONCumulatedRunningCapacity}.
 *
 * @author Fabien Hermenier
 */
public class JSONCumulatedRunningCapacity implements JSONSatConstraintConverter<CumulatedRunningCapacity> {
