...
/**
 * JSON Converter for the constraint {@link btrplace.model.constraint.JSONSingleRunningCapacity}.
 *
 * @author Fabien Hermenier
 */
public class JSONSingleRunningCapacity implements JSONSatConstraintConverter<SingleRunningCapacity> {
