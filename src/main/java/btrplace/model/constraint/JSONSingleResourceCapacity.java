...
/**
 * JSON Converter for the constraint {@link btrplace.model.constraint.JSONSingleResourceCapacity}.
 *
 * @author Fabien Hermenier
 */
public class JSONSingleResourceCapacity implements JSONSatConstraintConverter<SingleResourceCapacity> {
